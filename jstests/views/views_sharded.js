...
(function() {
    ...
    // assert.commandWorked(config.adminCommand({shardCollection: coll.getFullName(), key: {a:
    // 1}}));
    ...
    // assert.commandWorked(
    //     db.createView("even", {view: coll.getName(), pipeline: [{$match: {a: 0}}]}));
    // var view = db.getCollection("even");
