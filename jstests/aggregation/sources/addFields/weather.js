...
(function() {
    ...
    function generateRandomDocument() {
        ...
        return {
            month: Random.randInt(12),  // 0-11
            day: Random.randInt(31),    // 0-30
    ...
    print("Success! Standalone execution test for $addFields passed.");

    // Test against a sharded cluster.
    let st = new ShardingTest({shards: 2});
    doExecutionTest(st.s0);
    st.stop();
    print("Success! Sharding test for $addFields passed.");
